import sys
with open('C:/Users/LNWCPU/StudioProjects/motion_kit/lib/games/WanderPlaying.dart', 'r', encoding='utf-8') as f:
    text = f.read()
...
with open('C:/Users/LNWCPU/StudioProjects/motion_kit/lib/games/WanderPlaying.dart', 'w', encoding='utf-8') as f:
    f.write(text)
